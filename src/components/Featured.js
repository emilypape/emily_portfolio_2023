  ...
  return (
    <div>
      <div className='xl:ml-52 lg:ml-52 md:ml-16 xl:mr-52 lg:mr-52 md:mr-16 mt-10'>
        ...
        <div className='hidden lg:flex md:flex  text-start mt-5'>
        ...
        <div className='flex-wrap ml-16 lg:hidden md:hidden xl:hidden  text-start mt-5'>
        ...
        <div className='flex'>
          <div className='text-start ml-16 lg:ml-0 md:ml-0 xl:ml-0 font-semibold text-gray-500 mt-4'>
